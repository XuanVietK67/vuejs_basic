...
⚡ Agile phù hợp project thay đổi nhiều
...
<br/> <br/> <br/>
🧪 Example Project – Standalone Demo

⚠️ NOTE
Phần dưới đây là demo project độc lập,
KHÔNG liên quan tới workflow phía trên.
Chỉ dùng để minh hoạ cách tổ chức code trong thực tế.

🚀 Simple Application with Vue 3 (Register Form)

Demo project xây dựng Register Form với kiến trúc feature-based, áp dụng:
...
👉 đồng bộ style • tái sử dụng • code sạch
